...
class MassItemStackStorageSpec : WordSpec({
    "A mass ItemStack storage" should {
        ...
        "accept only stacks of the same item and data when not empty" {
            val m = MassItemStackStorage(1, storedStack = ItemStack(TestItems.StandardItemA))
